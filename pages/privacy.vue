...
<template>
    <div>
        ...
        <div class="max-w-screen-xl m-auto px-4 lg:px-10 pt-10 pb-20 text-gray-500">
            ...
            <p>Answerfansai built the Answerfansai service (including all apps we provided) as a Commercial service. This
                SERVICE is provided by Answerfansai and is intended for use as is.</p>
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
                accessible at Answerfansai unless otherwise defined in this Privacy Policy.</p>
            ...
            <ul>
                ...
                <li class="list-disc list-inside">We want to inform users of this Service that these third parties have
